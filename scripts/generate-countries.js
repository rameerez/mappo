...
import anchors from "./data/country-anchors.js";
...
// And the codes Natural Earth has no feature for at all at this scale (Hong
// Kong, Monaco, the Channel Islands…): hand-kept anchors, the way the body
// gazetteers are.
for (const a of anchors) {
  if (!A2.test(a.id) || out.has(a.id)) continue;
  out.set(a.id, { id: a.id, name: a.name, rings: [], anchor: [ round(a.lat), round(a.lon) ] });
}
